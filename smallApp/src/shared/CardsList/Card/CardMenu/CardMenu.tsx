...
const LIST = [
  { As: 'li' as const, text: 'Комментарии', className: 'list-item', svg: <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { As: 'li' as const, text: 'Поделиться', className: 'list-item', svg: <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { As: 'li' as const, text: 'Скрыть', className: 'list-item' , svg: <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { As: 'li' as const, text: 'Сохранить', className: 'list-item', svg: <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  { As: 'li' as const, text: 'Пожаловаться', className: 'list-item', svg: <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
